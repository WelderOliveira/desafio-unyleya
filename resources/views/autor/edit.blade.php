                    ...
                    <form action="{{ route('updateAutor', $autor->id) }}" method="POST" name="form" id="form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="nacionalidade" name="nacionalidade" class="form-control {{$errors->has('nacionalidade')?'is-invalid':''}}" required>
                                    <option selected {{$autor->nacionalidade ?? ''}}">{{$autor->nacionalidade ?? ''}}</option>
