                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('storeLivro') }}" method="POST" name="form" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="titulo" name="titulo" value="{{old('titulo')}}" class="form-control {{$errors->has('titulo')?'is-invalid':''}}" required>
                        </div>

                        <div class="form-group">
                            <label for="dt_lancamento">Data de Lançamento</label>
                            <input type="date" id="dt_lancamento" name="dt_lancamento" value="{{old('dt_lancamento')}}" class="form-control {{$errors->has('dt_lancamento')?'is-invalid':''}}" required>
                        </div>
